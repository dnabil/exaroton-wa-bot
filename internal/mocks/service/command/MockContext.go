...
func (_mock *MockContext) Reply(message string) error {
...
//   - message
func (_e *MockContext_Expecter) Reply(message interface{}) *MockContext_Reply_Call {
	return &MockContext_Reply_Call{Call: _e.mock.On("Reply", message)}
}

func (_c *MockContext_Reply_Call) Run(run func(message string)) *MockContext_Reply_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string))
	})
	return _c
...
func (_c *MockContext_Reply_Call) RunAndReturn(run func(message string) error) *MockContext_Reply_Call {
	_c.Call.Return(run)
	return _c
}
